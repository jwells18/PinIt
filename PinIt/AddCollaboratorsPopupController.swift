//
//  AddCollaboratorsPopupController.swift
//  WalkieTalkie
//
...
protocol AddCollaboratorsPopupDelegate {
    func didPressAddCollaboratorsFromContacts()
}

class AddCollaboratorsPopupController: UIViewController{
    
    var addCollaboratorsPopupDelegate: AddCollaboratorsPopupDelegate!
    ...
    func setupNavigationBar(){
        //Setup NavigationBar
        self.navigationItem.title = NSLocalizedString("Add collaborators", comment: "")
    ...
    func chooseFromContactsButtonPressed(){
        self.dismiss(animated: true) { 
            self.addCollaboratorsPopupDelegate.didPressAddCollaboratorsFromContacts()
        }
    }
}
